...
<table class="profile">
	...
	<tr>
		...
		<td><?php echo form_input('first_name', set_item_form_value('first_name', $item->first_name));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('Middle Name', 'middle_name')?></td>
		<td><?php echo form_input('middle_name', set_item_form_value('middle_name', $item->middle_name));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('Last Name', 'last_name')?></td>
		<td><?php echo form_input('last_name', set_item_form_value('last_name', $item->last_name));?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><?php echo form_input('address_1', set_item_form_value('address_1', $item->address_1));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('Address 2', 'address_2')?></td>
		<td><?php echo form_input('address_2', set_item_form_value('address_2', $item->address_2));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('City', 'city')?></td>
		<td><?php echo form_input('city', set_item_form_value('city', $item->city));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('State', 'state')?></td>
		<td><?php echo form_input('state', set_item_form_value('state', $item->state));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('ZIP', 'zip_code')?></td>
		<td><?php echo form_input('zip_code', set_item_form_value('zip_code', $item->zip_code));?></td>
	</tr>
	<tr>
		<td><?php echo form_label('Phone number', 'phone_number')?></td>
		<td><?php echo form_input('phone_number', set_item_form_value('phone_number', $item->phone_number));?></td>
	</tr>
